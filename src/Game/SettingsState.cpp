...
void SettingsState::imGui() {
                                              ...
                                              ImGuiWindowFlags_NoResize))
    {
        ...
        level(level1, LevelParams(300, 4, 15, 2, 0, 10, 10, 4, 3), Textures::level1Background);
        ImGui::SameLine();
        level(level2, LevelParams(500, 4, 20, 2, 0, 9, 9, 5, 5), Textures::level2Background);
        ImGui::SameLine();
        level(level3, LevelParams(600, 3, 20, 2, 0, 8, 8, 6, 7), Textures::level3Background);
        ImGui::SameLine();
        level(level4, LevelParams(600, 3, 25, 3, 0, 7, 7, 7, 9), Textures::level4Background);
        ImGui::SameLine();
        level(level5, LevelParams(800, 2, 25, 3, 0, 6, 6, 8, 10), Textures::level5Background);
